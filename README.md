...
*   [GCSS](https://github.com/yosssi/gcss) - 一个用GO语言编写的CSS预处理器。
*   [LESS](http://lesscss.org/) - 向下兼容CSS并为当前的CSS增加额外的功能。
*   [Myth](https://github.com/segmentio/myth) - 只用写纯CSS而不用担心浏览器加载缓慢。
...
*   [Bootstrap](http://getbootstrap.com/) - 最流行的HTML、CSS、JS框架
...
*   [Basscss](http://www.basscss.com/) - 一个基本元素样式与不可修改工具轻量级集合
*   [Bourbon](http://bourbon.io/) - 用于Sass的简单且轻量的混合库
*   [Corpus](http://corpuscss.com/) - 另一个CSS工具集
*   [Susy](http://susy.oddbird.net/) - 用于Sass的响应式工具集。
